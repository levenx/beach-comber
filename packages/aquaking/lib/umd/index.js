...
(function (global, factory) {
  ...
  (global = typeof globalThis !== 'undefined' ? globalThis : global || self, global.AquaKing = factory());
  ...
  const { browser, engine, os } = new uaParser_1().getResult();
  const payloadHeader = {
      sdkVersion: "1.0.0",
  ...
  function assemblePayload(event, params) {
  ...
  if (!localStorage.getItem('aqua_king_unique')) {
      localStorage.setItem('aqua_king_unique', JSON.stringify({ webid: v4().replace('/-/', '') }));
  }
